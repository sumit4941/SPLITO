...
| V2 validation/business logic   | Partial         | Zod/domain validation and Oracle constraints; controller allowlist and authorization coverage audit pending                                                                                                                                                       |
...
| V12 secure communication       | Operational     | HTTPS ingress and Oracle TCPS are deployment requirements; local HTTP is development-only                                                                                                                                                                         |
...
| V15 secure coding/architecture | Partial         | Bound SQL rule, typed layers, threat model, CodeQL; complete review pending                                                                                                                                                                                       |
