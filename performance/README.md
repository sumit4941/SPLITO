...
operations. It uses real cookie authentication and Oracle-backed routes with this
...
postings, and a 30-day outbox history. Record exact application/Oracle commits,
...
observed Oracle/pool saturation. Repeat at least three times after warm-up and
